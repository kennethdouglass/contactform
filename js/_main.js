/*
    For the demo page wrapper. Not required for the form handling.
*/
  ...
  */
  this.init = function () {
    ...
    */
    ...
    /* Waypoints triggering
      $('#mainTrigger').waypoint(function(direction) { 
        if (direction === "down") {
          // do something        
        } else {
          // do something 
    ...
    */
    ...
    $("#testclick").on( "click", function() {
      ctrpup('https://www.dev3.texture.com/storefront/auth/?activationToken=E3E2A1AA3235','amz',555,600);
      return false;
    });
    */
