...
/*
 ...
 <h2>Demo</h2>
<div id="box1" onmouseout="jQuery(this).stop().animate({boxShadow: '0 0 10px #000'})" onmouseover="jQuery(this).stop().animate({boxShadow: '0 0 30px #44f'})">mouse over</div>
<div id="box2" onmouseout="jQuery(this).stop().animate({boxShadow: '0 0 10px #699, 0 0 10px #969, 0 0 10px #996, 0 0 30px #669'})" onmouseover="jQuery(this).stop().animate({boxShadow: '-30px 0 30px #699, 30px 0 30px #969, 0 -30px 30px #996, 0 30px 30px #669'})" style="box-shadow: 0px 0px 10px 0px rgb(102, 153, 153), 0px 0px 10px 0px rgb(153, 102, 153), 0px 0px 10px 0px rgb(153, 153, 102), 0px 0px 30px 0px rgb(102, 102, 153);">mouse over</div>
<div id="box3" onmouseout="jQuery(this).stop().animate({boxShadow: '0 0 0'}, 'fast')" onmouseover="jQuery(this).stop().animate({boxShadow: '0 0 50px'}, 'fast')">mouse over</div>
<div id="box4" onmouseup="jQuery(this).stop().animate({boxShadow: '10px 10px 15px', top: 0}, 'fast')" onmousedown="jQuery(this).stop().animate({boxShadow: '3px 3px 3px', top: 3}, 'fast')" style="top: 0px; box-shadow: 10px 10px 15px 0px rgb(102, 102, 102);">click me</div>
*/
